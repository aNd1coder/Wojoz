...
namespace Wojoz.Config
{
    ...
    public class GeneralConfigs
    {
        ...
        public static bool SetIpDenyAccess(string denyipaccess)
        {
            ...
            lock (lockHelper)
            {
                try
                {
                    ...
                    GeneralConfigs.Serialiaze(configInfo, UrlHelper.GetMapPath(Wojoz.Config.DbConfigs.GetSitePath + "config/general.config"));
                    result = true;
                }
                catch
                {
        ...
        {
            GeneralConfigFileManager generalManger = new GeneralConfigFileManager();
            GeneralConfigFileManager.ConfigInfo = generalConfigInfo;
            return generalManger.SaveConfig();
        }
