...
namespace Wojoz.Cache
{
	...
	public class MemcachedClient 
	{
        ...
        /// <param name="command">命令行参数，该参数为修改版</param>
        ...
        private static ResourceManager _resourceManager = new ResourceManager("Wojoz.Cache.MemCached.StringMessages", typeof(MemcachedClient).Assembly);
